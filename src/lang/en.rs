...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Remotium network..."),
        ...
        ("install_tip", "Due to UAC, Remotium can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Remotium to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Remotium \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Remotium \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Remotium to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Remotium Input] service."),
        ("accessibility_disclosure_title", "Remotium needs the Accessibility Service"),
        ("accessibility_disclosure_why", "Why we use it: So that a support operator, with your permission and during a session you start, can control your screen (perform taps, gestures and scrolls) as if you were doing them yourself. This is a core function of Remotium: receiving live remote assistance."),
        ("accessibility_disclosure_what", "What it accesses: While the service is active, Remotium can read on-screen interface elements and send taps and gestures to the device to enable remote control. Your screen image is shared separately, only when you agree to share your screen."),
        ("accessibility_disclosure_how", "How the information is used: Control is transmitted in real time to the operator you authorize, only during the active session. Remotium does not use accessibility to collect your personal data for advertising, does not record call audio, and does not act on its own without a human operator. You can end the session or turn off the service at any time from Android Settings."),
        ("accessibility_disclosure_action", "By tapping Accept, we will take you to Android Settings so you can manually activate the \"Remotium Input\" service. If you do not wish to continue, tap Cancel."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Remotium application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Remotium \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Remotium \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Remotium."),
        ...
        ("verify_rustdesk_password_tip", "Verify Remotium password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Remotium and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Remotium from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Remotium"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Remotium window is open"),
        ...
        ("floating_window_tip", "It helps to keep Remotium background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Remotium client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Remotium verifies the server certificate for protocols using TLS.\nWith this option enabled, Remotium will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Remotium will not use UDP 21116 any more, TCP 21116 will be used instead."),
