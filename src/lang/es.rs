...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Remotium en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Remotium no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Remotium a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Remotium de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Remotium de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Remotium use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Remotium Input]."),
        ("accessibility_disclosure_title", "Remotium necesita el Servicio de Accesibilidad"),
        ("accessibility_disclosure_why", "Por qué lo usamos: Para que un operador de soporte, con tu permiso y durante una sesión que tú inicias, pueda controlar tu pantalla (realizar toques, gestos y desplazamientos) igual que si tú los hicieras. Esta es una función principal de Remotium: recibir asistencia remota en vivo."),
        ("accessibility_disclosure_what", "A qué accede: Mientras el servicio esté activo, Remotium puede leer elementos de la interfaz en pantalla y enviar toques y gestos al dispositivo para permitir el control remoto. La imagen de tu pantalla se comparte por separado, solo cuando tú aceptas compartir pantalla."),
        ("accessibility_disclosure_how", "Cómo se usa la información: El control se transmite en tiempo real al operador que tú autorizas, únicamente durante la sesión activa. Remotium no usa la accesibilidad para recopilar tus datos personales con fines publicitarios, no registra el audio de llamadas, y no realiza acciones por su cuenta sin un operador humano. Puedes finalizar la sesión o desactivar el servicio en cualquier momento desde los Ajustes de Android."),
        ("accessibility_disclosure_action", "Al pulsar Aceptar, te llevaremos a los Ajustes de Android para que actives manualmente el servicio \"Remotium Input\". Si no deseas continuar, pulsa Cancelar."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Dejar Remotium como Servicio en 2do plano"),
        ...
        ("Show RustDesk", "Mostrar Remotium"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Remotium permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Remotium permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Remotium"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Remotium e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Remotium no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de Remotium"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Remotium de fondo"),
        ...
        ("About RustDesk", "Acerca de Remotium"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente Remotium a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, Remotium verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, Remotium volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, Remotium no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
